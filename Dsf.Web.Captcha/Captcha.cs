...
namespace TaxPortal.Helpers
{
    public static class Captcha
    {
        ...
        {
            using (System.Drawing.Common.Bitmap baseMap = new Bitmap(width, height))
            using (Graphics graph = Graphics.FromImage(baseMap))
            {
                ...
                {
                    //KK Added -20 to get smaller fonts
                    var averageSize = (imageWidth -20) / captchCodeCount;
